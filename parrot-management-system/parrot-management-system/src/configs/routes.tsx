...
export const routes: RouteObject[] = [
  ...
  { path: "/dashboard", element: <Dashboard /> },
  {
    path: "/parrots",
    children: [
      { index: true, element: <ParrotListPage /> },
      { path: "list", element: <ParrotListPage /> },
      { path: "add", element: <AddParrotPage /> },
    ],
  },
  {
    path: "/breeding",
    children: [
      { index: true, element: <BreedingManagementPage /> },
      { path: "breeding-birds", element: <BreedingManagementPage /> },
    ],
  },
  {
    path: "/incubation",
    children: [
      { index: true, element: <IncubationListPage /> },
      { path: "incubation-list", element: <IncubationListPage /> },
      { path: "chicks", element: <ChickManagementPage /> },
    ],
  },
  {
    path: "/sales",
    children: [
      { index: true, element: <SalesRecordsPage /> },
      { path: "sales-records", element: <SalesRecordsPage /> },
